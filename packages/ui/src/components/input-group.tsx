...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: a field wrapper cannot be a fieldset; it holds one control plus decoration
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useKeyWithClickEvents: click-to-focus is a pointer affordance; keyboard users reach the control by tab
		// biome-ignore lint/a11y/useSemanticElements: an addon groups decoration around a control, not a set of fields
		<div
			role="group"
