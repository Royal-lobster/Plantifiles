/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 247c64de12db09de80a3cefd3f3909ee)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VARS_ENV">> {}
}
