...
/**
 * A two-leaf sprout. The name already says "files", so the mark carries the
 * other half and stays legible at 16px, which a page-with-a-leaf did not.
 */
function Logo({ className }: { className?: string }) {
	return (
		<svg viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false" className={cn("size-4", className)}>
			<path d="M12 21.5V11.5" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" />
			<path d="M12 12.2C12 8.3 9.1 5.2 5.5 5.2c0 3.9 2.9 7 6.5 7Z" fill="currentColor" />
			<path d="M12 14.4c0-3.4 2.5-6.2 5.7-6.2 0 3.5-2.5 6.2-5.7 6.2Z" fill="currentColor" opacity="0.55" />
		</svg>
	);
}
